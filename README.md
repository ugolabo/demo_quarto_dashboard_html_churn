...
HTML dashboard on a statistical technique using R. Right click to: <a href="https://ugolabo.github.io/demo_quarto_dashboard_html_churn/demo_customer_churn_analysis_dashboard.html#definition" target="_blank">site</a>.  
...
<img src="demo_dashboard_quarto_html_churn.png" alt="" width="500px" >
...
| **Web Page Setup** | Settings > Pages, **gh-pages branch**, **/ (root)** | Settings > Pages, main branch, / (root) |
